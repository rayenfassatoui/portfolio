            ...
            <div className="grid md:grid-cols-[1fr_2fr] gap-12 md:gap-24 items-start">
                ...
                <div className="border-t border-border/20">
                    {DATA.services.map((service, i) => (
                        <motion.div key={i} variants={itemVariants} className="group flex items-center justify-between py-8 border-b border-border/20 hover:border-primary/50 transition-colors cursor-pointer">
